...
class FirebaseService{
  ...
  uploadData(BuildContext context,File imageFile,double latitude,double longitude,String timestamp)async{
    ...
    return await uploadImageToFirebase(context, imageFile,timestamp);

  }
  Future uploadImageToFirebase(BuildContext context,File imageFile,String timestamp) async {
